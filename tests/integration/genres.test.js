...
describe('/api/genres',()=>{
    ...
    afterEach(async()=>{
        await server.close();
        //clean the documents stored in the database
    ...
    describe('GET /:id',()=>{
        ...
        it('should return a 400 if id is not in the database',async()=>{
    ...
    describe('POST /',()=>{
        ...
        beforeEach(()=>{
            //in beforeach we set the values of the happy path
            token = new User().generateAuthToken();
            name = 'genre1';
        });

        it('should return 401 if the valid client is not logged in',async()=>{
            token = '';
    ...
    describe('PUT /:id', () => {
        ...
        it('should return 400 if genre with the given id was not found', async () => {
